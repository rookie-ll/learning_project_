...
class TestOldIssues(base.PyMySQLTestCase):
    ...
    def test_issue_8(self):
        ...
        conn = self.connections[0]
        c = conn.cursor()
        c.execute("""CREATE TABLE `my_test` (`station` int(10) NOT NULL DEFAULT '0', `dh`
datetime NOT NULL DEFAULT '1000-01-01 00:00:01', `echeance` int(1) NOT NULL
DEFAULT '0', `me` double DEFAULT NULL, `mo` double DEFAULT NULL, PRIMARY
KEY (`station`,`dh`,`echeance`)) ENGINE=MyISAM DEFAULT CHARSET=latin1;""")
        try:
            c.execute("SELECT * FROM my_test")
            c.execute("ALTER TABLE `my_test` ADD INDEX `idx_station` (`station`)")
            c.execute("SELECT * FROM my_test")
        finally:
            c.execute("drop table my_test")
...
class TestNewIssues(base.PyMySQLTestCase):
    ...
    @unittest.skip("This my_test requires manual intervention")
