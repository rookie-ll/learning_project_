...
class TestConversion(base.PyMySQLTestCase):
    ...
    def test_string(self):
        ...
        test_value = "I am a my_test string"
        try:
    ...
    def test_untyped(self):
        """ my_test conversion of null, empty string """
        conn = self.connections[0]
        c = conn.cursor()
...
class TestCursor(base.PyMySQLTestCase):
    # this my_test case does not work quite right yet, however,
    ...
    def test_fetch_no_result(self):
        """ my_test a fetchone() with no rows """
        conn = self.connections[0]
        c = conn.cursor()
