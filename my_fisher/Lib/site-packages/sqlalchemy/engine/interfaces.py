    ...
    * connectivity plugins such as proxies
    ...
    URL as in::
        ...
        engine = create_engine(
          "mysql+pymysql://scott:tiger@localhost/my_test?plugin=myplugin")

    Alternatively, the :paramref:`.create_engine.plugins" argument may be
    passed as a list to :func:`.create_engine`::

        engine = create_engine(
          "mysql+pymysql://scott:tiger@localhost/my_test",
          plugins=["myplugin"])
    ...
    in the URL::
        ...
        engine = create_engine(
          ...
          "my_test?plugin=plugin_one&plugin=plugin_twp&plugin=plugin_three")
    ...
    following::
        ...
        engine = create_engine(
          "mysql+pymysql://scott:tiger@localhost/"
          "my_test?plugin=myplugin&my_argument_one=foo&my_argument_two=bar",
