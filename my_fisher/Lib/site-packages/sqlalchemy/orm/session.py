...
class Session(_SessionClassMethods):
        ...
        for state in states:
            ...
            if obj is not None:
                ...
                if state.key is None:
                    ...
                    # map (see my_test/orm/test_naturalpks.py ReversePKsTest)
                    self.identity_map.safe_discard(state)
                ...
                # are swapped; see my_test/orm/test_naturalpks.py -> test_reverse
    ...
    def bulk_save_objects(
        ...
        .. warning::
            ...
            **before using this method, and fully my_test and confirm the
    ...
    def is_modified(self, instance, include_collections=True, passive=None):
        ...
        :attr:`.Session.dirty` collection; a full my_test for
...
def close_all_sessions():
    ...
    This function is not for general use but may be useful for my_test suites
