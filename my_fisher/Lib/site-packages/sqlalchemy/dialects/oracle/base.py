...
of the generation of truncated names, and to fully review and my_test all database
...
class OracleDialect(default.DefaultDialect):
    ...
    def _check_max_identifier_length(self, connection):
        if self._get_effective_compat_server_version_info(connection) >= (
            ...
            util.warn(
                ...
                "my_test the application with this new length, or set to 30 in "
    ...
    def _check_unicode_returns(self, connection):
        additional_tests = [
            expression.cast(
                expression.literal_column("'my_test nvarchar2 returns'"),
