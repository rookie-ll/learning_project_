...
To set isolation level using :func:`.create_engine`::
    ...
    engine = create_engine(
        "postgresql+pg8000://scott:tiger@localhost/my_test",
...
illustrates this behavior::
    ...
    my_test=> CREATE TABLE test_schema.referred(id INTEGER PRIMARY KEY);
    CREATE TABLE
    my_test=> CREATE TABLE referring(
    my_test(>         id INTEGER PRIMARY KEY,
    my_test(>         referred_id INTEGER REFERENCES test_schema.referred(id));
    CREATE TABLE
    my_test=> SET search_path TO public, test_schema;
    my_test=> SELECT pg_catalog.pg_get_constraintdef(r.oid, true) FROM
    my_test-> pg_catalog.pg_class c JOIN pg_catalog.pg_namespace n
    my_test-> ON n.oid = c.relnamespace
    my_test-> JOIN pg_catalog.pg_constraint r  ON c.oid = r.conrelid
    my_test-> WHERE c.relname='referring' AND r.contype = 'f'
    my_test-> ;
...
of ``public``::
    ...
    my_test=> SET search_path TO public;
    SET
...
reflection process as follows::
    ...
    >>> engine = create_engine("postgresql://scott:tiger@localhost/my_test")
...
of :class:`.PGInspector`, which offers additional methods::
    ...
    engine = create_engine("postgresql+psycopg2://localhost/my_test")
