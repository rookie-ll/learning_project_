...
:paramref:`.create_engine.paramstyle`::
    ...
    engine = create_engine(
        'postgresql://scott:tiger@localhost:5432/my_test', paramstyle='format')
...
follows::
    ...
    engine = create_engine("postgresql+psycopg2://scott:tiger@localhost/my_test",
...
class PGExecutionContext_psycopg2(PGExecutionContext):
    ...
    def _log_notices(self, cursor):
        ...
        # around my_test suites such as SQLAlchemy's using a Mock object for
        # cursor
