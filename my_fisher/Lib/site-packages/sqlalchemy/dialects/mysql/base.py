...
To set isolation level using :func:`.create_engine`::
    ...
    engine = create_engine(
                    "mysql://scott:tiger@localhost/my_test",
...
in the URL, such as::
    ...
    e = create_engine(
        "mysql+pymysql://scott:tiger@localhost/my_test?charset=utf8mb4")
...
string parameter ``binary_prefix=true`` to the URL to repair this warning::
    ...
    # mysqlclient
    engine = create_engine(
        "mysql+mysqldb://scott:tiger@localhost/my_test?charset=utf8mb4&binary_prefix=true")

    # PyMySQL
    engine = create_engine(
        "mysql+pymysql://scott:tiger@localhost/my_test?charset=utf8mb4&binary_prefix=true")
...
``nullable=False``.   The following example illustrates::
    ...
    e = create_engine("mysql://scott:tiger@localhost/my_test", echo=True)
    m.create_all(e)
