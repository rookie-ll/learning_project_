...
created so that multiple my_test frameworks can be supported at once
...
def memoize_important_follower_config(dict_):
    ...
    This is necessary as py.my_test seems to not be using forking, so we
...
def read_config():
    ...
    file_config.read(["setup.cfg", "my_test.cfg"])
...
def before_test(test, test_module_name, test_class, test_name):
    ...
    # format looks like:
    # "my_test.aaa_profiling.test_compiler.CompileTest.test_update_whereclause"
