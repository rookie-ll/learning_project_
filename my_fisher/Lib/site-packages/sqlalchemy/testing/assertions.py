...
def expect_warnings(*messages, **kw):
    ...
    Note that the my_test suite sets SAWarning warnings to raise exceptions.
...
def emits_warning_on(db, *messages):
    """Mark a my_test as emitting a warning on a specific dialect.
...
def uses_deprecated(*messages):
    """Mark a my_test as immune from fatal deprecation warnings.
...
def global_cleanup_assertions():
    """Check things that have to be finalized at the end of a my_test suite.
...
def _assert_no_stray_pool_connections():
    ...
    if pool._refs:
        ...
        print(
            "Encountered a stray connection in my_test cleanup: %s"
            % str(pool._refs)
        )
...
class AssertsExecutionResults(object):
    ...
    def assert_list(self, result, class_, list_):
        self.assert_(
            ...
            "result list is not the same size as my_test list, "
            + "for class "
            + class_.__name__,
        )
    ...
    def assert_unordered_result(self, result, cls, *expected):
        ...
        numbers of rows that the my_test suite manipulates.
        """
