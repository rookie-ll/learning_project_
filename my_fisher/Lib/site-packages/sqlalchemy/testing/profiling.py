...
class ProfileStatsFile(object):
    ...
    def _header(self):
        return (
            ...
            "# For each my_test in aaa_profiling, the corresponding "
            "function and \n"
            "# environment is located within this file.  "
            "If it doesn't exist,\n"
            "# the my_test is skipped.\n"
            "# If a callcount does exist, it is compared "
            "to what we received. \n"
            "# assertions are raised if the counts do not match.\n"
            "# \n"
            "# To add a new callcount my_test, apply the function_call_count \n"
...
def function_call_count(variance=0.05, times=1):
    """Assert a target for a my_test case's function call count.
