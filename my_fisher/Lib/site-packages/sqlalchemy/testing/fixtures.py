...
# as far as how py.my_test collection works.
...
class TestBase(object):
    ...
    # A sequence of dialect names to exclude from the my_test class.
    __unsupported_on__ = ()

    # If present, my_test class is only runnable for the *single* specified
...
class MappedTest(_ORMTest, TablesTest, assertions.AssertsExecutionResults):
    ...
    def _teardown_each_mappers(self):
        # some tests create mappers in the my_test bodies
