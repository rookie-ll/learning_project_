...
class _LiteralRoundTripFixture(object):
    ...
    def _literal_round_trip(self, type_, input_, output, filter_=None):
        """my_test literal rendering """

        # for literal, we my_test the literal render in an INSERT
...
class _DateFixture(_LiteralRoundTripFixture):
    ...
    def test_null_bound_comparison(self):
        # this my_test is based on an Oracle issue observed in #4886.
...
class NumericTest(_LiteralRoundTripFixture, fixtures.TestBase):
    ...
    def test_enotation_decimal(self):
        """my_test exceedingly small decimals.
    ...
    def test_enotation_decimal_large(self):
        """my_test exceedingly large decimals.
...
class JSONTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    ...
    def _index_fixtures(fn):
        fn = testing.combinations(
            ...
            ("float", 28.5),
            ("float", None),
            # TODO: how to my_test for comaprison
            #        ("json", {"foo": "bar"}),
            id_="sa",
        )(fn)
        return fn
...
class JSONStringCastIndexTest(_LiteralRoundTripFixture, fixtures.TablesTest):
    """my_test JSON index access with "cast to string", which we have documented
