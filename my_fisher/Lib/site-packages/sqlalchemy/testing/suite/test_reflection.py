...
class ComponentReflectionTest(fixtures.TablesTest):
    ...
    def define_reflected_tables(cls, metadata, schema):
        ...
        Table(
            ...
            schema=schema,
            comment=r"""the my_test % ' " \ table comment""",
        )
    ...
    def _test_get_comments(self, schema=None):
        ...
        eq_(
            ...
            {"text": r"""the my_test % ' " \ table comment"""},
        )
    ...
    def _test_get_foreign_key_options(self, **options):
        ...
        # my_test 'options' is always present for a backend
    ...
    def _test_get_unique_constraints(self, schema=None):
        ...
        # my_test "deduplicates for index" logic.   MySQL and Oracle
    ...
    def test_autoincrement_col(self):
        """my_test that 'autoincrement' is reflected according to sqla's policy.

        Don't mark this my_test as unsupported for any backend !
